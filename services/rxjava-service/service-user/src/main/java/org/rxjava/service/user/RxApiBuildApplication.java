...
public class RxApiBuildApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        //设置Java生成后的文件夹路径
        String javaOutPath = new File(moduleAbsolutePath, "../../rxjava-test/service-user-api/src/main/java/").getAbsolutePath();
        //设置Js生成后的文件夹路径
        ...
        javaClientApiGenerator.setRootPackage("org.rxjava.api.user");
